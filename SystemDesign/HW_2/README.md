...
| Функция | Описание |
|---|---|
| CRUD для счетов | Создание, редактирование, удаление, просмотр |
| CRUD для категорий | Создание, редактирование, удаление, просмотр |
| CRUD для операций | Создание, редактирование, удаление, просмотр |
| Пересчёт баланса | Пересчёт баланса счёта на основе всех его операций |
...
Или в IntelliJ IDEA: открыть папку проекта → IDEA подхватит `build.gradle` → запустить `Main.java`.
