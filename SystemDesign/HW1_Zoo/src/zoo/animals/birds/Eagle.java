...
public class Eagle extends Bird implements Feedable, Treatable, Cleanable, Flyable {
    private double dailyFoodAmountKg;
    private int feedingsPerDay;

    public Eagle(String name, int age, double weight, double wingspan, String featherColor, double dailyFoodAmountKg, int feedingsPerDay) {
    ...
    @Override
    public void fly() {
        System.out.println("Орел " + name + " летит");
    }
}